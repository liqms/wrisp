export default {
  ...
  SETTINGS: {
    ...
    DEFAULT_MODEL_GENERAL: "General Default Model",
    DEFAULT_MODEL_GENERAL_DESC: "Fallback model when no creation type is specified",
    TASK_TYPE: {
    ...
    AI_SETTINGS: {
      ...
      FETCH_MODELS_HINT: "Fill in API Key then click fetch",
