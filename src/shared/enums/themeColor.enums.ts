...
> = {
  [THEME_MODE.LIGHT]: {
    [THEME_COLOR.RED]: {
      ...
      backgroundColor: "rgb(233, 49, 71, 0.1)",
    },
    [THEME_COLOR.ORANGE]: {
      primaryColor: "#ec7500",
      ...
      backgroundColor: "rgb(236, 117, 0, 0.1)",
    },
    [THEME_COLOR.YELLOW]: {
      primaryColor: "#e0ac00",
      ...
      backgroundColor: "rgb(224, 172, 0, 0.1)",
    },
    [THEME_COLOR.GREEN]: {
      ...
      backgroundColor: "rgb(24, 160, 88, 0.1)",
    },
    [THEME_COLOR.CYAN]: {
      primaryColor: "#00bfbc",
      ...
      backgroundColor: "rgb(0, 191, 188, 0.1)",
    },
    [THEME_COLOR.BLUE]: {
      primaryColor: "#2d8cff",
      ...
      backgroundColor: "rgb(45, 140, 255, 0.1)",
    },
    [THEME_COLOR.PURPLE]: {
      primaryColor: "#7852ee",
      ...
      backgroundColor: "rgb(120, 82, 238, 0.1)",
    },
    [THEME_COLOR.PINK]: {
      primaryColor: "#d53984",
      ...
      backgroundColor: "rgb(213, 57, 132, 0.1)",
    },
    [THEME_COLOR.BROWN]: {
      primaryColor: "#a67c52",
      ...
      backgroundColor: "rgb(166, 124, 82, 0.1)",
    },
  },
  [THEME_MODE.DARK]: {
    [THEME_COLOR.RED]: {
      ...
      backgroundColor: "rgb(251, 70, 76, 0.1)",
    },
    [THEME_COLOR.ORANGE]: {
      primaryColor: "#ec7500",
      primaryColorHover: "#ff7a00",
    ...
    [THEME_COLOR.GREEN]: {
      ...
      primaryColorPressed: "#5acea7",
      primaryColorSuppl: "rgb(42, 148, 125)",
      backgroundColor: "rgb(99, 226, 183, 0.1)",
    },
    [THEME_COLOR.CYAN]: {
      primaryColor: "#00bfbc",
      primaryColorHover: "#00d9d7",
...
// 工具函数：根据 hex 颜色值转换rgb颜色值，Naive UI 的某些组件（如 NProgress）需要使用 rgb 格式的颜色值
