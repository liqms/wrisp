...
async function startSmartTasks(): Promise<ApiResponse<{ executionId: string }>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_START_FAILED, error as Error);
  }
}
...
async function cancelSmartTasks(): Promise<ApiResponse<void>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_CANCEL_FAILED, error as Error);
  }
}
...
async function pauseSmartTasks(): Promise<ApiResponse<void>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_PAUSE_FAILED, error as Error);
  }
}
...
async function resumeSmartTasks(): Promise<ApiResponse<void>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_RESUME_FAILED, error as Error);
  }
}
...
async function getSmartTaskStatus(): Promise<ApiResponse<unknown>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_STATUS_FAILED, error as Error);
  }
}
...
async function getSmartTaskHistory(): Promise<ApiResponse<unknown>> {
  try {
    ...
    return response.error(ErrorCode.SMART_TASK_HISTORY_FAILED, error as Error);
  }
}
