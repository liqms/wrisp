import { app, Notification, OpenDialogOptions, OpenDialogReturnValue, dialog, screen } from 'electron'
import os from 'os'
...
class SystemService {
   ...
   * @param body - 通知内容
   */
  public showSystemNotification(level: NotificationLevel, title: string, body: string): void {
    try {
